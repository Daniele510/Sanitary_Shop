<section class="row modify gap-3">
    ...
    <form action="./processa-modifiche.php?action=ins-new-prod" method="POST" enctype="multipart/form-data" class="col-10 col-md-9 needs-validation white-container-column px-3 inputs" novalidate>
