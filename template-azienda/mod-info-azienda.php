<div class="row modify">
    ...
    <form action="processa-modifiche.php?action=mod-info-azienda" method="POST" class="col-10 col-md-9 needs-validation inputs" novalidate>
        ...
        <div class="row fields">
            <div class="row">
                <div class="row">
                    <label for="validationCompanyName" class="col-12 col-form-label form-label align-self-center">Nome Compangia <span class="text-danger" aria-hidden="true">*</span></label>
