<section class="row modify gap-3">
    ...
    <form action="processa-modifiche.php?action=mod-info-azienda" method="POST" class="col-10 col-md-9 needs-validation needs-confermation white-column-container px-3 inputs" novalidate>
