<div class="row registration" id="registrazione-azienda">
    ...
    <form action="./area-aziende/processa-modifiche.php?action=ins-new-azienda" method="POST" class="col-10 col-md-9 inputs needs-validation" novalidate>
        ...
        <div class="row fields">
            <div class="row">
                <div class="row">
                    <label for="validationCompanyName" class="col-12 col-form-label form-label align-self-center">Nome Compagnia <span class="text-danger" aria-hidden="true">*</span></label>
                ...
                <div class="row">
                    <label for="validationIVANum" class="col-12 col-form-label form-label align-self-center">Partita IVA <span class="text-danger" aria-hidden="true">*</span></label>
                    <div class="col-12 input">
                ...
                <div class="row">
                    <label for="validationPhoneNum" class="col-12 col-form-label form-label align-self-center">Numero di telefono <span class="text-danger" aria-hidden="true">*</span></label>
                    <div class="col-12 input">
                ...
                <div class="row addr-form">
                    <div class="row">
                        <label for="validationAddr" class="col-12 col-form-label form-label">Indirizzo sede <span class="text-danger" aria-hidden="true">*</span></label>
                        <div class="col-12 input">
