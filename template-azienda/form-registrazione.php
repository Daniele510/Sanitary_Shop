            ...
            <div class="row">
                ...
                <div class="row addr-form">
                    <div class="row">
                        ...
                        <div class="col-12 input">
                            <input type="text" class="form-control justify-self-center" id="validationAddr" placeholder="Via dell'Università 50" name="Ind_Via" required pattern="((V|v)ia|(V|v)iale|(C|c)orso|(P|p)iazza|(P|p)iazzale)\s[a-zA-Z\s'\.]+\s\d{1,3}[a-z]?" aria-describedby="invalid-feedback-addr">
