<div class="row p-0 m-0 justify-content-center">
    <div class="col-10 p-0 col-md-11 d-flex flex-column flex-md-row-reverse justify-content-md-around gap-md-5">
        <div class="col-md-4 p-0 d-flex aside">
            <div class="col-12 d-flex justify-content-between flex-md-column align-items-md-end justify-content-md-start">
                <a class="btn outline-secondary d-flex align-items-center justify-content-between" href="prodotti-compagnia.php?action=ins-new-prod">
