<nav class="navbar col-12 header-sticky" <?php if (isset($templateParams["ColoreCategoria"]) && $templateParams["ColoreCategoria"] !== "06ACB8") {
    ...
    <ul class="navbar-nav fixed-bottom col-12 d-flex justify-content-around align-items-center flex-row bg-white col-md-5 justify-content-md-start" <?php if (isset($templateParams["ColoreCategoria"]) && $templateParams["ColoreCategoria"] !== "06ACB8") {
        ...
        <li class="nav-item justify-content-center allign-items-center justify-content-md-start w-auto">
            <a class="nav-link<?php isActive("index.php"); ?> text-reset me-md-auto" href="index.php">
                <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="home-icon" role="img">
        ...
        <li class="nav-item justify-content-center allign-items-center justify-content-md-start w-auto">
            <a class="nav-link<?php isActive("prodotti-compagnia.php"); ?> text-reset ms-md-auto" href="prodotti-compagnia.php">
                <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="prod-icon" role="img">
        ...
        <li class="nav-item justify-content-center allign-items-center justify-content-md-start w-auto">
            <a class="nav-link<?php isActive("login.php"); ?> text-reset ms-md-4" href="login.php" id="login_link">
                <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="login-icon" role="img">
    ...
    <form action="prodotti-compagnia.php" method="GET" class="col-9 d-flex col-md-6">
        <input class="form-control mr-sm-2" type="search" list="suggestions" placeholder="Search" aria-label="Search" name="NomeProdotto" <?php if (isset($filtri["NomeProdotto"])) : ?> value="<?php echo $filtri["NomeProdotto"]; ?>" <?php endif; ?> autocomplete="off">
