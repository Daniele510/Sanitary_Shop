            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="col-12 input">
                        <input type="tel" class="form-control" id="validationCodeProduct" name="CodProdotto" pattern="\d{1,10}[\s-]?" required>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <input class="form-control" type="file" accept="image/*" id="formFile" name="Immagine" required>
                        <div class="invalid-feedback">
                ...
                <div class="row justify-content-between price">
                    <div class="col-6 col-md-12">
                        ...
                        <div class="input">
                            <input type="number" class="form-control" id="validationPrice" name="Prezzo" pattern="\d{1,8}" step="0.01" min="1" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-5 col-md-12">
                        ...
                        <div class="input">
                            <input type="number" class="form-control" id="validationDiscount" name="Sconto" min="0">
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    ...
                    <div class="col-12 input">
                        <input type="number" class="form-control" id="validationMaxQta" name="MaxQta" min="1" required>
                    </div>
                    <div class="invalid-feedback">
                        **Inserire un numero positivo
                    </div>
