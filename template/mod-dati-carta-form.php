        ...
        <div class="col-12 vstack fields p-0">
            <fieldset class="col-12 vstack">
                ...
                <div class="col-12">
                    ...
                    <div>
                        <input type="text" class="form-control" id="validationDataScadenza" name="DataScadenza" value="<?php echo $templateParams["info-utente"]["MeseScadenza"] . " " . $templateParams["info-utente"]["AnnoScadenza"]; ?>" required pattern="\d{2}\s\d{4}"  aria-describedby="invalid-feedback-date">
