<section class="row justify-content-center">
  <div class="col-10 d-flex flex-column gap-5 col-md-11">
    ...
    <div class="col-12 d-flex gap-5 align-items-start justify-content-start" id="container_ordini">
      <?php if (!empty($templateParams["ordini"])) : ?>
        <div class="d-contents d-md-flex col-12 gap-4 gap-lg-3 align-items-start">

          <ul class="list-group p-0 col-12 col-md-5">
          ...
          <section class="flex-grow-1 <?php echo isset($_GET["CodOrdine"]) ? "open" : "opacity-0"; ?>  opacity-md-100 d-flex justify-content-center" id="box_info_ordine">
            ...
            <div>
              ...
              <ul class="col-12 d-flex flex-column gap-4">
                <?php foreach ($templateParams["stati-prodotto"] as $stato) : ?>
                  <li>
                    <span>
                      Data: <?php echo $stato["Data"]; ?>
                    </span>
                    <span class="ms-4"><?php echo $stato["NomeStato"]; ?></span>
                  </li>
                <?php endforeach; ?>
              </ul>
            </div>
