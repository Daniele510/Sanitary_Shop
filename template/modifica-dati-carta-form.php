<div class="row  d-flex justify-content-center">
    ...
    <form action="#" method="POST" class="col-10 col-md-9 needs-validation d-flex flex-column inputs" style="padding-bottom: 2rem; padding-top: 1rem; border-radius: 10px; background: white; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);" novalidate>
